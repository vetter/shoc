...
extern "C" void downloadFunc(const long long numBytes, float* data,
        double* totalTime);
...
void RunBenchmark(ResultDatabase &resultDB, OptionParser &op)
{
    ...
    for (int pass = 0; pass < passes; pass++)
    {
        ...
        for (int i = 0; i < nSizes; i++)
        {
            ...
            downloadFunc(nbytes, hostMem, &transferTime);
            ...
            resultDB.AddResult("DownloadTime", sizeStr, "ms", transferTime);
        }
    }
