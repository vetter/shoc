...
__global__ void radixSortBlocks(hipLaunchParm lp, const uint nbits, const uint startbit,
...
//----------------------------------------------------------------------------
__global__ void reorderData(hipLaunchParm lp, uint  startbit,
                            uint  *outKeys,
                            uint  *outValues,
                            uint2 *keys,
                            uint2 *values,
...
__global__ void
scan(hipLaunchParm lp, uint *g_odata, uint* g_idata, uint* g_blockSums, const int n,
...
__global__ void
vectorAddUniform4(hipLaunchParm lp, uint *d_vector, const uint *d_uniforms, const int n)
{
