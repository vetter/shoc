...
ratt_kernel(__global const real* T, __global real* RF, real TCONV)
{
    ...
    RF(8) = CPREC(5.5e20)*TI2;
    RF(9) = CPREC(2.2e22)*TI2;
    RF(10) = CPREC(5.e17)*TI;
    RF(11) = CPREC(1.2e17)*TI;
    ...
    RF(51) = CPREC(1.056e13) * TMP;
    RF(52) = CPREC(2.64e12) * TMP;
    RF(53) = CPREC(2.e13);
    ...
    RF(76) = CPREC(1.e12) * TMP;
    RF(127) = CPREC(5.e13) * TMP;
    RF(129) = CPREC(1.e13) * TMP;
    ...
    RF(92) = CPREC(1.2e13) * TMP;
    RF(107) = CPREC(1.6e13) * TMP;
    ...
    RF(116) = CPREC(1.632e7) * TMP;
    RF(117) = CPREC(4.08e6) * TMP;
    ...
    RF(131) = CPREC(7.5e12) * TMP;
    RF(152) = CPREC(1.e13) * TMP;
    RF(186) = CPREC(2.e13) * TMP;
    RF(132) = EXP(CPREC(2.94360258e1) +CPREC(2.7e-1)*ALOGT -CPREC(1.40900667e2)*TI);
    RF(133) = CPREC(3.e13);
    RF(134) = CPREC(6.e13);
    RF(135) = CPREC(4.8e13);
    RF(136) = CPREC(4.8e13);
    RF(137) = CPREC(3.011e13);
    ...
    RF(143) = CPREC(9.033e13);
    RF(144) = CPREC(3.92e11);
    RF(145) = CPREC(2.5e13);
    ...
    RF(150) = CPREC(2.e13) * TMP;
    RF(151) = CPREC(2.e13) * TMP;
    RF(153) = CPREC(1.4e11);
    RF(154) = CPREC(1.8e10);
    ...
    RF(159) = CPREC(1.92e7) * TMP;
    RF(160) = CPREC(3.84e5) * TMP;
    ...
    RF(171) = CPREC(2.e12);
    RF(172) = CPREC(1.604e13);
    RF(173) = CPREC(8.02e13);
    RF(174) = CPREC(2.e10);
    RF(175) = CPREC(3.e11);
    RF(176) = CPREC(3.e11);
    RF(177) = CPREC(2.4e13);
