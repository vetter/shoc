...
//#pragma unroll 22
    ...
    real CTB_10 = CTOT + C(1) + CPREC(5.e0) * C(6) + C(10) +
                    CPREC(5.e-1) * C(11) + C(12) + CPREC(2.e0) * C(16) +
                    CPREC(2.e0) * C(14) + CPREC(2.e0) * C(15);
    real CTB_114 = CTOT + C(1) + CPREC(5.e0) * C(6) + C(10) +
                    CPREC(5.e-1) * C(11) + C(12) + CPREC(2.e0) * C(16) +
                    CPREC(1.5e0) * C(14) + CPREC(1.5e0) * C(15);
    real CTB_16 = CTOT + C(1) + CPREC(5.e0) * C(6) + C(10) +
                    CPREC(5.e-1) * C(11) + C(12) + CPREC(2.e0) * C(16) +
                    CPREC(2.e0) * C(14) + CPREC(2.e0) * C(15);
    ...
    PCOR = DIV(PR, (CPREC(1.0) + PR));
    PRLOG = LOG10(MAX(PR, SMALL));
    FCENT = CPREC(2.654e-1) * EXP(DIV(-TEMP, CPREC(9.4e1))) +
            CPREC(7.346e-1) * EXP(DIV(-TEMP, CPREC(1.756e3))) +
            EXP(DIV(-CPREC(5.182e3), TEMP));
    FCLOG = LOG10(MAX(FCENT, SMALL));
    XN = CPREC(0.75) - CPREC(1.27) * FCLOG;
    CPRLOG = PRLOG - (CPREC(0.4) + CPREC(0.67) * FCLOG);
    SQR = DIV(CPRLOG, (XN - CPREC(0.14) * CPRLOG));
    FLOG = DIV(FCLOG, (CPREC(1.0) + SQR * SQR));
    FC = EXP10(FLOG);
    PCOR = FC * PCOR;
    RF(16) = RF(16) * PCOR;
    RB(16) = RB(16) * PCOR;
    ...
    PCOR = DIV(PR, (CPREC(1.0) + PR));
    PRLOG = LOG10(MAX(PR, SMALL));
    FCENT = CPREC(6.8e-2) * EXP(DIV(-TEMP, CPREC(1.97e2))) +
            CPREC(9.32e-1) * EXP(DIV(-TEMP, CPREC(1.54e3))) +
    ...
    PCOR = DIV(PR, (CPREC(1.0) + PR));
    PRLOG = LOG10(MAX(PR, SMALL));
    FCENT = CPREC(4.243e-1) * EXP(DIV(-TEMP, CPREC(2.37e2))) +
            CPREC(5.757e-1) * EXP(DIV(-TEMP, CPREC(1.652e3))) +
    ...
    PCOR = DIV(PR, (CPREC(1.0) + PR));
    PRLOG = LOG10(MAX(PR, SMALL));
    FCENT = CPREC(2.176e-1) * EXP(DIV(-TEMP, CPREC(2.71e2))) +
            CPREC(7.824e-1) * EXP(DIV(-TEMP, CPREC(2.755e3))) +
    ...
    PCOR = DIV(PR, (CPREC(1.0) + PR));
    PRLOG = LOG10(MAX(PR, SMALL));
    FCENT = CPREC(3.2e-1) * EXP(DIV(-TEMP, CPREC(7.8e1))) +
            CPREC(6.8e-1) * EXP(DIV(-TEMP, CPREC(1.995e3))) +
    ...
    PCOR = DIV(PR, (CPREC(1.0) + PR));
    PRLOG = LOG10(MAX(PR, SMALL));
    FCENT = CPREC(4.093e-1) * EXP(DIV(-TEMP, CPREC(2.75e2))) +
            CPREC(5.907e-1) * EXP(DIV(-TEMP, CPREC(1.226e3))) +
    ...
    PCOR = DIV(PR, (CPREC(1.0) + PR));
    PRLOG = LOG10(MAX(PR, SMALL));
    FCENT = CPREC(2.42e-1) * EXP(DIV(-TEMP, CPREC(9.4e1))) +
            CPREC(7.58e-1) * EXP(DIV(-TEMP, CPREC(1.555e3))) +
    ...
    PCOR = DIV(PR, (CPREC(1.0) + PR));
    PRLOG = LOG10(MAX(PR, SMALL));
    FCENT = CPREC(2.17e-1) * EXP(DIV(-TEMP, CPREC(7.4e1))) +
            CPREC(7.83e-1) * EXP(DIV(-TEMP, CPREC(2.941e3))) +
    ...
    PCOR = DIV(PR, (CPREC(1.0) + PR));
    PRLOG = LOG10(MAX(PR, SMALL));
    FCENT = CPREC(3.827e-1) * EXP(DIV(-TEMP, CPREC(1.3076e1))) +
            CPREC(6.173e-1) * EXP(DIV(-TEMP, CPREC(2.078e3))) +
    ...
    PCOR = DIV(PR, (CPREC(1.0) + PR));
    PRLOG = LOG10(MAX(PR, SMALL));
    FCENT = CPREC(4.675e-1) * EXP(DIV(-TEMP, CPREC(1.51e2))) +
            CPREC(5.325e-1) * EXP(DIV(-TEMP, CPREC(1.038e3))) +
